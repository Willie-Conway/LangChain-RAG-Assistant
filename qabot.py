...
# Load IBM API key from environment variable
IBM_API_KEY = os.environ.get("IBM_CLOUD_API_KEY")
if not IBM_API_KEY:
    raise EnvironmentError("Please set the IBM_CLOUD_API_KEY environment variable")

# Initialize credentials once
creds = Credentials(apikey=IBM_API_KEY)
...
# Launch the app with dynamic port for Render or other cloud services
